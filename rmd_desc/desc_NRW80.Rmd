...
I host a R script on my GitHub account (see <https://raw.githubusercontent.com/hubchev/courses/main/scr/readin_GESIS.R>) that explains how to import the NRW80+ data. You find the content of the script below. I have manually saved the data, `gesis.RData`, in a subfolder named `gesis.RData`.
