...
authornote: |
  Alle Dateien im Zusammenhang mit diesem Dokument findet man hier: [https://github.com/hubchev/ewa](https://github.com/hubchev/ewa). Kontakt bitte über `stephan.huber@hs-fresenius.de` aufnehmen.
