...
\begin{figure}
\centering
\includegraphics{desc_test_files/figure-latex/aboxplot-1.pdf}
...
\begin{figure}
\centering
\includegraphics{desc_test_files/figure-latex/iplotdauerkog-1.pdf}
\caption{\label{fig:iplotdauerkog}Interaction Plot: \texttt{dauer} and \texttt{modus}}
\end{figure}

\begin{figure}
\centering
\includegraphics{desc_test_files/figure-latex/iplotdauermod-1.pdf}
...
\begin{figure}
\centering
\includegraphics{desc_test_files/figure-latex/df3boxplot-1.pdf}
