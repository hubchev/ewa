...
authornote: |
  Alle Dateien im Zusammenhang mit diesem Document findet man hier: [https://github.com/hubchev/ewa](https://github.com/hubchev/ewa). 

abstract: |
  In diesem Dokument paper, I illustrate the process of making nice tables and graphics that are related to ANOVA and had been shown in the lecture. The paper adheres to the APA style, implementing the R template provided by the 'papaja' package [@R-papaja].
