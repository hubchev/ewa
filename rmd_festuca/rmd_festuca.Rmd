...
abstract: |
  This is an exercise where data management with the `dplyr` functions `pivot_longer`, `rename`, and `bind_rows` is practiced. Moreover, I exemplify how an ANOVA analysis can be executed with R. Doing so I refer to the content of @Childs2021APS[chapter 27]. All data to this exercise can be found in @Huber2024Empirisch. 
---
...
```{r pressure, echo=FALSE, fig.cap="Understanding the model graphically", out.width = '100%'}
